...
mod tests {
    ...
    fn bind_transmitter_to_bytes() {
        ...
        let expected: Vec<u8> = vec![
            ...
            0x53, 0x4D, 0x50, 0x50, 0x33, 0x54, 0x45, 0x53, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, // password (9 bytes): "secret08" + null
            0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x30, 0x38, 0x00,
            // system_type (13 bytes): "SUBMIT1" + null + padding
            0x53, 0x55, 0x42, 0x4D, 0x49, 0x54, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            // interface_version (1 byte)
            0x34, // addr_ton (1 byte)
            0x01, // addr_npi (1 byte)
            0x01, // address_range (41 bytes): null + padding
    ...
    fn bind_transmitter_to_bytes_no_password() {
        ...
        let expected: Vec<u8> = vec![
            // Header:
            0x00, 0x00, 0x00,
            0x62, // command_length (98 bytes total - same size as with password due to fixed fields)
            0x00, 0x00, 0x00, 0x02, // command_id
            0x00, 0x00, 0x00, 0x00, // command_status
            0x00, 0x00, 0x00, 0x01, // sequence_number
            // Body (fixed-length fields):
            // system_id (16 bytes): "SMPP3TEST" + null + padding
            0x53, 0x4D, 0x50, 0x50, 0x33, 0x54, 0x45, 0x53, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, // password (9 bytes): empty + null + padding
    ...
    fn bind_transmitter_to_bytes_with_address_range() {
        ...
        let expected: Vec<u8> = vec![
            // Header:
            0x00, 0x00, 0x00,
            0x62, // command_length (98 bytes total - same as other tests due to fixed fields)
            0x00, 0x00, 0x00, 0x02, // command_id
            0x00, 0x00, 0x00, 0x00, // command_status
            0x00, 0x00, 0x00, 0x01, // sequence_number
            // Body (fixed-length fields):
            ...
            0x34, // addr_ton (1 byte)
            0x01, // addr_npi (1 byte)
            0x01, // address_range (41 bytes): "123456789" + null + padding
            0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ];
    ...
    fn bind_transmitter_to_bytes_different_interface_version() {
        ...
        let expected: Vec<u8> = vec![
            ...
            0x33, // addr_ton (1 byte) - National
            0x02, // addr_npi (1 byte) - Data
            0x03, // address_range (41 bytes): null + padding
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ];
    ...
    fn bind_transmitter_response_to_bytes_no_tlv() {
        ...
        let expected: Vec<u8> = vec![
            // Header:
            0x00, 0x00, 0x00,
            0x20, // command_length (32 bytes total: 16 header + 16 system_id)
